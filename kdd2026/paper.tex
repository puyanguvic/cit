...
or a protocol/log event~\cite{he2017drain,du2017deeplog}.
...
tabular and semi-structured prediction pipelines~\cite{yin2020tabert,herzig2020tapas,wang2021tuta,deng2022turl}.
Structured prediction on databases and tables is also commonly studied via semantic parsing and text-to-SQL benchmarks~\cite{zhong2017seq2sql,yu2018spider}.
Complementary work explores specialized deep architectures for tabular prediction that do not rely on record-to-text serialization~\cite{huang2020tabtransformer,gorishniy2021revisiting}.
...
sequence length due to self-attention~\cite{vaswani2017attention,kaplan2020scaling,zhai2022scaling}.
Efficient long-sequence Transformer variants exist (e.g., sparse attention), but they are not drop-in replacements
in our strict interface setting~\cite{beltagy2020longformer,zaheer2020bigbird,guo2019star}.
...
in contrast to classical approximation guarantees available for greedy maximization of submodular objectives~\cite{nemhauser1978analysis},
