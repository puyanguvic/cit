...
\bottomrule
\end{tabular*}
\caption{Vocabulary-budget frontier sweep on Adult. We report interface-level rate (avg./P95 token length), surrogate distortion $\hat{\Delta}$, and tokenization time under deterministic, prefix-emitting execution. Within each vocabulary budget, best values (lower is better) are shown in bold.}
\label{tab:frontier}
\end{table}
