...
The byte-level baseline confirms that the task signal is recoverable under a lossless interface, but at a much higher rate; CIT attains high semantic fidelity at substantially lower interface cost.
...
Bytes & 0.042 & 0.041 & 1057.9 & 0.453 \\
CIT & 1.000 & 0.826 & 81.0 & 0.295 \\
Unigram & 0.056 & 0.053 & 691.7 & 0.667 \\
WordPiece & 0.045 & 0.027 & 648.0 & 0.663 \\
\bottomrule
\end{tabular}
...
tokenizers with lower $\widehat{\Delta}(\tau)$ exhibit improved robustness under drift, even under token-fair training budgets.
...
Compared to the lossless byte-level baseline, CIT targets similar robustness at a far lower interface cost by enforcing interface constraints rather than relying on lossless tokenization.
...
CIT reduces average and tail sequence lengths relative to standard subword baselines, yielding consistent latency reductions at matched or improved accuracy.
