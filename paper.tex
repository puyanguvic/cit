...
\caption{E2 (CSIC 2010 HTTP) token-fair frontier (10M tokens, $L_{\max}{=}512$): accuracy vs.\ average sequence length across tokenizers and model sizes.}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.32\linewidth]{Figs/e3_pareto_acc_vs_len.pdf}
\hfill
\includegraphics[width=0.32\linewidth]{Figs/e3_pareto_acc_vs_latency.pdf}
\hfill
\includegraphics[width=0.32\linewidth]{Figs/e3_pareto_acc_vs_params.pdf}
\caption{E3 (Pareto slice, Adult): (left) accuracy vs.\ average length, (middle) accuracy vs.\ P95 latency, (right) accuracy vs.\ parameter count.}
\label{fig:e3_pareto}
\end{figure*}
