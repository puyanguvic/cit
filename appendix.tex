...
Table~\ref{tab:appendix_frontier} reports the aggregated sweep results, and Figure~\ref{fig:appendix_frontier} visualizes the corresponding frontiers and runtime trade-offs.
\input{results/paper/paper_artifacts/appendix/tables/frontier}
\begin{figure}[t]
\centering
\includegraphics[width=0.48\linewidth]{paper_figures/frontier_acc_vs_len.pdf}
\hfill
\includegraphics[width=0.48\linewidth]{paper_figures/frontier_acc_vs_distortion.pdf}\\
\includegraphics[width=0.48\linewidth]{paper_figures/frontier_len_vs_distortion.pdf}
\hfill
\includegraphics[width=0.48\linewidth]{paper_figures/frontier_tokenize_ms_vs_len.pdf}
