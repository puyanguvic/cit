...
\input{results/Tables/e2_csic_token_fair}

\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{results/Figs/e2_csic_token_fair_frontier_acc_vs_len.pdf}
...
\input{results/Tables/e3_pareto}
