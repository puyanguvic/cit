...
Overall, CIT improves operating points on the accuracy--latency Pareto frontier by simultaneously reducing interface cost and preserving task-relevant prefix information (lower surrogate distortion).
