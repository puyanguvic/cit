...
in our strict interface setting~\cite{beltagy2020longformer,zaheer2020bigbird}.
...
\emph{Budget-matched learned tokenizers} (BPE~\cite{sennrich2016neural}, WordPiece~\cite{schuster2012japanese,wu2016gnmt}, Unigram~\cite{kudo2018subword}) are trained on the task's training serialization and constrained to a fixed vocabulary budget ($|\mathcal{V}|{=}2048$), matching CIT.
...
\emph{Tokenization-free and byte/character-level encoders} provide alternative interfaces but change the modeling stack and are not in our drop-in regime~\cite{xue2022byt5,clark2022canine,yu2023megabyte}.
