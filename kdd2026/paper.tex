...
In a scan of six widely used pretrained tokenizers on 5{,}000 CSIC 2010 HTTP requests with $L_{\max}{=}512$, average sequence lengths range from 359--468 tokens and 7--29\% of examples exceed the limit (29.4\% for BERT WordPiece; 7.3\% for a GPT-3.5/GPT-4-family tokenizer; Table~\ref{tab:e0_tokenizer_playground}).
