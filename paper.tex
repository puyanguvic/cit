...
\input{results/paper/paper_artifacts/main/tables/e1_synth}
...
\input{results/paper/paper_artifacts/main/tables/e2_csic_token_fair}
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{paper_figures/e2_csic_token_fair_frontier_acc_vs_len.pdf}
...
\input{results/paper/paper_artifacts/main/tables/e2_csic_convergence}
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{paper_figures/e2_csic_token_fair_learning_curves_tiny.pdf}
...
\input{results/paper/paper_artifacts/main/tables/e3_pareto}
\begin{figure}[t]
\centering
\includegraphics[width=0.32\linewidth]{paper_figures/e3_pareto_acc_vs_len.pdf}
\hfill
\includegraphics[width=0.32\linewidth]{paper_figures/e3_pareto_acc_vs_latency.pdf}
\hfill
\includegraphics[width=0.32\linewidth]{paper_figures/e3_pareto_acc_vs_params.pdf}
...
% Appendix moved to a separate file for easier editing.
\input{appendix}
