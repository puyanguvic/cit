...
Table~\ref{tab:e2_csic_token_fair} summarizes final accuracy, drift accuracy, and token-length statistics under token-fair training.
\input{results/paper/paper_artifacts/main/tables/e2_csic_token_fair}
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{results/paper/paper_artifacts/main/figures/e2_csic_token_fair_frontier_acc_vs_len.pdf}
\caption{E2 (CSIC 2010 HTTP) token-fair frontier: accuracy vs.\ average sequence length across tokenizers and model sizes.}
...
Beyond final accuracy, learning curves (validation accuracy vs.\ seen encoder tokens) show that CIT reaches strong operating points in fewer tokens and with fewer optimization steps under token-fair budgets.
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{results/paper/paper_artifacts/main/figures/e2_csic_token_fair_learning_curves_tiny.pdf}
\caption{E2 (CSIC 2010 HTTP) token-fair learning curves (Tiny): validation accuracy as a function of seen encoder tokens.}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.32\linewidth]{results/paper/paper_artifacts/main/figures/e3_pareto_acc_vs_len.pdf}
\includegraphics[width=0.32\linewidth]{results/paper/paper_artifacts/main/figures/e3_pareto_acc_vs_latency.pdf}
\includegraphics[width=0.32\linewidth]{results/paper/paper_artifacts/main/figures/e3_pareto_acc_vs_params.pdf}
