...
It also collects deferred proofs and additional context.
...
This paper focuses on drop-in tokenization interfaces for token-sequence predictors under strict deployment constraints; we note several complementary lines of work for context.
